...
describe("Blog", () => {
  ...
  it("Should render Comment, Author component correctly", () => {
    const wrapper = mountWithMock(Blog, mockData);
    expect(wrapper.html()).toBeTruthy()
    expect(Comment).toMatchSnapshot();
    expect(Author).toMatchSnapshot();
  });
  it("Should not render Author, Comment component ", () => {
    const wrapper = shallowWithMock(Blog, {});
    expect(wrapper.contains(<Author />)).toBe(false)
